      ...
      <div ref={this.props.setWrapperRef} id="main" style={this.props.timeout ? {display: 'flex'} : {display: 'none'}}>
        ...
        <article id="work" className={`${this.props.article === 'work' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{display:'none'}}>
          <h2 className="major">Assorted Projects</h2>
              ...
              <a href='https://github.com/team-anything/Briefly'>
                <div className="box">
              ...
              <a href='https://github.com/Welltested-AI/fluttergpt'>
                <div className="box">
                  <p><strong>FlutterGPT</strong></p>
                  <p>FlutterGPT is an open-source project aimed at creating a coding assistant specifically designed for Flutter Engineers. This assistant helps with creating, refactoring, and debugging code, making the development process more efficient and enjoyable.</p> 
                  <code>TypeScript</code> <code>VScode</code><code>OpenAI</code>
                </div>
              </a>
              <a href='https://github.com/team-anything/HelpOff'>
                <div className="box">
        ...
        <article id="about" className={`${this.props.article === 'about' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{display:'none'}}>
          ...
          <div className="box">
            ...
            <p>Building the next generation observability tool <a href="https://www.browserstack.com/test-observability">Test Observability</a>. Working with a bunch of awesome devs and product folks to deliver seamless experience and cutting edge features for testers around the world.</p>
          </div>
          <div className="box">
